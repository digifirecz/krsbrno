    ...
    return [
      {
        source: '/:path*',
        headers: [
          // Clickjacking: don't let the site be framed by another origin.
          { key: 'X-Frame-Options', value: 'SAMEORIGIN' },
          // Stop browsers guessing content types (e.g. an uploaded file as HTML).
          { key: 'X-Content-Type-Options', value: 'nosniff' },
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          // Force HTTPS for a year once a visitor has loaded the site once.
